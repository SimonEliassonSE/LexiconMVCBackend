...
namespace LexiconMVC.Controllers
{
    ...
    public class RoleController : Controller
    {
        ...
        // samma kod kan användas för Edit & Delet där vi använder _context. Detta är "Taghelper" metoden
        [HttpPost]
        ...
        // Gör på samma sätt(Utan Async) på Edit & Delete i city, country, people & language. 
